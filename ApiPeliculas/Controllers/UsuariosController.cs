...
namespace ApiPeliculas.Controllers
{
    ...
    [ApiController]
    /*
     * Ya con [ApiVersionNeutral] estamos indicando que por lo menos para usuarios va a ser una API que va a ser neutral,
     * no va a depender de ninguna versión de las diferentes versiones que tenga nuestra API.
    */
    [ApiVersionNeutral]
    public class UsuariosController : ControllerBase
    {
        private readonly IUsuarioRepositorio _usRepo;
        //Utilizamos una variable de tipo protegida cuando vamos ha accerder directamente a un modelo
